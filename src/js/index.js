...
window.addEventListener('DOMContentLoaded', () => {
  ...
  if(window.mobilecheck()) video.classList.add('is-hidden');

  // when bg video loaded...
  ...
  video.oncanplaythrough = () => {
    ...
    if(!videoPlayed && !window.mobilecheck()) {
      ...
      // delay rest of actions to avoid showing controls and blink
      setTimeout(() => {
        video.play()
          .then(() => {
            videoPlayed = true;
